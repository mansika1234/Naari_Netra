...
<%@page import="Controller.ServletCookie"%>
 <%
                   
              
                String pass1=ServletCookie.pass;
...
<jsp:include page="CookieHeader.jsp"/>  
	  ...
	  <div class="row">
	    ...
	    <div class="col-md-6">
		   ...
		   <table>
              <tbody>
              <form method="post" name="regForm" onsubmit="return validation()" action="eee">
                 <tr>
